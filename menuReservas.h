...
int diasEstadia=cd(entrada,salida);
int pos=tipoHabitacion-'0';
/// se le resta una unidad para que concuerde con la pos del archivo
float precioEstadia=precioPorNoche(pos-1);
estadiaCompleta=(float)diasEstadia*precioEstadia;
cout << "\t\tValor por noche: $"<< precioEstadia << endl;
...
cout << "\t\tPrecio de estadia completa: $"<< estadiaCompleta << endl;
